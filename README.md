...
Top run scorer among all batters in IPL 2025
Who has the highest strike rate? (min 15 matches)
Which batting position scores the most runs?
Most consistent player (high average + many matches)
Average strike rate of all batters team-wise
Which team has the most combined runs?
Find batters with more 6s than 4s (min 10 matches)

🟡 Intermediate Analysis

Find all batters who scored more than the average runs
Find the batter with the second highest run total
Highest run scorer from each team
Find the second highest run scorer in each team
Which player converts fifties into centuries best?

🔴 Advanced Analysis

Highest strike rate in each team (min 200 balls faced)
Top 5 run scorers in each team (using RANK window function)
Players who hit more sixes than their team average
Players whose average is higher than the average of all batters at the same position
Classify players as STAR PLAYER / CONSISTENT / EXPLOSIVE (using CASE)
Identify players as Boundary Dependent / Balanced / Accumulator
Which player contributes the highest percentage of their team's runs?
Find players whose average is higher than their positional average
